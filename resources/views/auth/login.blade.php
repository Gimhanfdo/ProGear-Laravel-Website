    ...
    <div
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1 w-full border border-gray-300 dark:border-gray-600 rounded-lg 
                           focus:ring-2 focus:ring-teal-500 focus:border-teal-500
                           dark:bg-gray-800 dark:text-gray-100 dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
            ...
            <div>
                ...
                <x-text-input id="password" class="block mt-1 w-full border border-gray-300 dark:border-gray-600 rounded-lg 
                           focus:ring-2 focus:ring-teal-500 focus:border-teal-500
                           dark:bg-gray-800 dark:text-gray-100 dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
            ...
            <div class="flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-teal-600 focus:ring-teal-500
            ...
            <div class="flex items-center justify-between">
                @if (Route::has('password.request'))
                    <a class="text-sm text-teal-600 font-bold hover:underline dark:text-indigo-400"
            ...
            <!-- Google Login -->
            <a href="{{ url('login/google') }}" class="flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-gray-300 bg-white 
                       hover:bg-gray-50 shadow-sm transition
                       dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700">
                <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google logo"
                    class="w-5 h-5">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-200">Login with Google</span>
            </a>
